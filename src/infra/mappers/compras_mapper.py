...
compras = Table(
    ...
    Column("data_atualizacao", DateTime, nullable=True),
    ...
    Column("data_inclusao", DateTime, nullable=True),
    Column("data_abertura_proposta", DateTime, nullable=True),
    Column("data_encerramento_proposta", DateTime, nullable=True),
    Column("data_publicacao_pncp", DateTime, nullable=True),
    Column("data_atualizacao_global", DateTime, nullable=True),
